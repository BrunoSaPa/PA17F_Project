...
public class MantenimientoAlmacenistas : PaginaBase
{
	    ...
	    try
	    {
	    	// Solicitar los nuevos valores de almacenista
   		    if (AlmacenistaActual.IdUsuarioNavigation != null)
   		    {
	            ...
	            AlmacenistaActual.IdUsuarioNavigation.FchModificacion = Utilidades.ObtenerFechaActualEnBytes();
	...
	*/
	public void Mostrar()
	{
	    ...
	    {
	        Console.WriteLine($"Ultima fecha de modificación: {Utilidades.ObtenerFechaDesdeBytes(UsuarioActual.FchModificacion)}");
	    }
	    else
	    {
